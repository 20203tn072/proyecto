            ...
            <tr>
                <td>
                    <a href="${context}/views/user/register.jsp">
                        <img src="${context}/assets/dist/img/add-user.png" href="${context}/views/user/register.jsp">
                    </a>
                </td>
                <td class="columna"></td>
                <td>
                    <a href="${context}/views/user/users.jsp">
                        <img src="${context}/assets/dist/img/list-user.png" href="${context}/views/user/users.jsp" >
                    </a>
                </td>
            </tr>
        </table>
    ...
    <center>
        <table>
            <tr>
                <td>
                    <a href="${context}/views/user/register.jsp">
                        <img src="${context}/assets/dist/img/list-incidents.png" href="${context}/views/user/register.jsp">
                    </a>
                </td>
            </tr>
        </table>
