...
<h5>Registrar Usuario | Enlace</h5>
...
<center>
    <form action="${context}/createUser" method="POST">
        ...
        <br>
        <a href="${context}/views/user/inicio.jsp"><button type="button" class="btn btn-secondary"><i class="fas fa-times"></i> Cancelar</button></a>
