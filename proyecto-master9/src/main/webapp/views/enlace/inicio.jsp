...
<nav class="navbar navbar-light" style="background-color: hotpink;" >
    <a class="navbar-brand" href="#">
        <font face="Arial Rounded MT" size="4" color="black">ENLACE</font>
    </a>
    <a class="navbar-brand" href="#">
        ...
        <tr>
            <td>
                <a href="${context}/views/enlace/register.jsp">
                    <img src="${context}/assets/dist/img/add-user.png" href="${context}/views/enlace/register.jsp" hspace="50" vspace="50">
                </a>
            </td>
            <td class="columna"></td>
            <td>
                <a href="${context}/readUsers2">
                    <img src="${context}/assets/dist/img/list-user.png" href="${context}/views/enlace/users.jsp" hspace="50" vspace="50">
                </a>
            </td>
        </tr>
    </table>
...
<div class="opciones">
    <center>
        <table>
            <tr>
                <td>
                    <a href="${context}/views/presidente/incidentes.jsp">
                        <img src="${context}/assets/dist/img/list-incidents.png" href="${context}/views/enlace/incidentes.jsp" hspace="50" vspace="">
                    </a>
                </td>
            </tr>
        </table>
