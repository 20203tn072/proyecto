...
public class BeanUserEnlace{
    ...
    public BeanUserEnlace() {
    }

    public BeanUserEnlace(long idUser, String nombre, String lastname, String password, String email, int status, BeanRole idRole, BeanMunicipio idMunicipio, String colonia) {
        this.idUser = idUser;
        this.nombre = nombre;
...
public class BeanUserEnlace {
    ...
    public BeanUserEnlace(long idUser, String nombre, String lastname, String password, String email, int status, BeanRole idRole, String colonia) {
        this.idUser = idUser;
        this.nombre = nombre;
        this.lastname = lastname;
        this.password = password;
