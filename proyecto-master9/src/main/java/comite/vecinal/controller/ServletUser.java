...
@WebServlet(name = "ServletUser", value = {"/ServletUser", "/readUsers","/readEnlace", "/createUser", "/getUserById", "/findById", "/updateUser", "/deleteUser" })
public class ServletUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("listUsers1", new DaoUser().findEnlace());//SIRVE ADMIN/USER
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(action){
            case "create":
                ...
                BeanUser beanUser = new BeanUser(0, name, lastname, password, email, 0, beanRole, beanMunicipio);
            ...
            case "update":
                ...
                BeanUser beanUser1 = new BeanUser(id1, name1, lastname1, password1, email1, 0, beanRole1,beanMunicipio1 );
