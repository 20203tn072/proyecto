...
<nav class="navbar navbar-light" style="background-color:white;">
    ...
    <a class="navbar-brand" href="${context}/views/incidente/inicio.jsp">
...
<nav class="navbar navbar-light" style="background-color: hotpink;" >
    <a class="navbar-brand" href="#">
        <font face="Arial Rounded MT" size="4" color="black">PRESIDENTE</font>
    </a>
    <a class="navbar-brand" href="#">
...
<div class="opciones">
    <center>
        <table>
            <tr>
                <td>
                    <a href="${context}/views/presidente/crearIncidente.jsp">
                        <img src="${context}/assets/dist/img/add-incident.png" href="${context}/views/enlace/register.jsp" hspace="50" vspace="50">
                    </a>
                </td>
                <td class="columna"></td>
                <td>
                    <a href="${context}/readIncidents">
                        <img src="${context}/assets/dist/img/list-incidents.png" href="${context}/views/presidente/incidentes.jsp" hspace="50" vspace="50">
                    </a>
                </td>
            </tr>
        </table>
