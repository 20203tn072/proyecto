...
<head>
    ...
    <link rel="stylesheet" href="${context}/assets/dist/css/stylesForm.css.css">
</head>
<body>
...
<h5>Registrar Usuario | Comité</h5>
<center>
    <form action="${context}/createUser2" method="POST">
        <input type="hidden" value="create" name="action">
        <label>Nombre(s):</label>
        <input class="form-control" type="text" name="name" style="width:30%"/>
        <br>
        <label>Apellido(s):</label>
        <input class="form-control" type="text" name="lastname" style="width:30%"/>
        <br>
        <label>Correo:</label>
        <input class="form-control" type="email" name="email" style="width:30%"/>
        <br>
        ...
        <select class="form-select" name="role" style="width:30%">
            ...
            <option value="4">Subpresidente</option>
            <option value="5">Vocal</option>
        </select>
        <br>
        <label>Municipio:</label>
        <select class="form-select" name="municipio" value="${ user.idMunicipio.nombre }"style="width:30%">
        ...
        <br>
        <label>Colonia:</label>
        <input class="form-control" type="text" name="colonia" style="width:30%"/>
        <br>
        <a href="${context}/views/enlace/inicio.jsp"><button type="button" class="btn btn-secondary"><i class="fas fa-times"></i> Cancelar</button></a>
