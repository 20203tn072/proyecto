...
<html>
<head>
    <title>Modificar Usuario | Comite</title>
...
<nav class="navbar navbar-light" style="background-color: hotpink;" >
    ...
    <a class="navbar-brand" href="${context}/readUsers2" style="text-align: right">
...
<center>
    <form action="${context}/updateUser2" method="POST">
        ...
        <br>
        <label>Colonia:</label>
        <input class="form-control" type="text" name="colonia" value="${ user.colonia }"style="width:30%"/>
        <br>
        <a href="${context}/readUsers2"><button type="button" class="btn btn-secondary"><i class="fas fa-times"></i> Cancelar</button></a>
        <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> Modificar</button>
