        ...
        <center>
            <div class="opciones">
                ...
                <a href="${context}/readUsers">
                    <img src="${context}/assets/dist/img/list-user.png" href="" width=auto height=auto hspace="50" vspace="50">
                </a>
                <a href="${context}/views/user/register.jsp">
                    <img src="${context}/assets/dist/img/add-user.png" href="" width=auto height=auto hspace="50" vspace="50">
                </a>
            </div>
        </center>
    </div>
