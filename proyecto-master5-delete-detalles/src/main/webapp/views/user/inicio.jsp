        ...
        <center>
            <div class="opciones">
                ...
                <a href="${context}/readUsers">
                    <img src="${context}/assets/dist/img/list-user.png" href="" width="150px" height="185px" hspace="20" vspace="20">
                </a>
                <a href="${context}/views/user/register.jsp">
                    <img src="${context}/assets/dist/img/add-user.png" href="" width="150px" height="185px" hspace="20" vspace="20">
                </a>
            </div>
        </center>
    </div>
